...
class NetworkPort(BaseModel):
    ...
    ip_addresses: Optional[conlist(StrictStr)] = None
    __properties = ["port_id", "port_name", "network_id", "ip_addresses"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NetworkPort:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NetworkPort:
        """Create an instance of NetworkPort from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NetworkPort.parse_obj(obj)

        _obj = NetworkPort.parse_obj({
